                             ...
                             <div class="row my-2">
                                 ...
                                 <div class="col-sm-4">
                                     ...
                                     <a href="#addUserModal" class=" btn btn-success" data-toggle="modal"><i
                                             class="material-icons">&#xe147;</i>Add New Rating</a>
                                 ...
                                 <div class="modal-content" style="color:black;">
                                     <form action="">
                                         <div class="modal-header">
                                             <h5 class="modal-title">Add Rating
                                             </h5>
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <div class="form-group">
                                                 <label for="rateScore">Rate Score</label>
                                                 <input type="text" id="rateScore" class="form-control" required>
                                             </div>
                         ...
                         <div id="editUserModal" class="modal fade">
                             <div class="modal-dialog">
                                 <div class="modal-content" style="color:black;">
                                     <form action="">
                                         <div class="modal-header">
                                             <h5 class="modal-title">Edit Rating Info
                                             </h5>
                                             <button type="button" class="close" data-dismiss="modal" aria-label="close"
                                                 aria-hidden="true">&times;
                                             </button>
