                             ...
                             <div class="row my-2">
                                 ...
                                 <div class="col-sm-4">
                                     ...
                                     <a href="#addUserModal" class=" btn btn-success" data-toggle="modal"><i
                                             class="material-icons">&#xe147;</i>Add New Comments</a>
                                 ...
                                 <div class="modal-content" style="color:black;">
                                     <form action="">
                                         <div class="modal-header">
                                             <h5 class="modal-title">Add Comment
                                             </h5>
                                         ...
                                         <div class="modal-body">
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" id="commentId" class="form-control" required>
                                             </div>
                                             <div class="form-group">
                         ...
                         <div id="editUserModal" class="modal fade">
                             <div class="modal-dialog">
                                 <div class="modal-content" style="color:black;">
                                     <form action="">
                                         <div class="modal-header">
                                             <h5 class="modal-title">Edit Comment Info
                                             </h5>
                                             <button type="button" class="close" data-dismiss="modal" aria-label="close"
                                                 aria-hidden="true">&times;
                                             </button>
