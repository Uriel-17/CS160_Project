...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light py-4 index-forward" style="background-color: #334e68">
            ...
            align-items-center
          ">
                <a class="navbar-brand" img src="~/img/logo.png" alt="..." width="150" href="#">Logo</a>
                <form class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-9">
                ...
                <ul class="col-lg-3">
                    <li class="list-inline-item"><a action="register.php" href="register.php">Sign up</a></li>
                    <li class="list-inline-item"><a action="login.php" href="login.php">Login</a></li>
                </ul>
            </div>
        </nav>
    </header>
