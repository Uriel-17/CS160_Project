...
<body>
    <!--footer-->
    <footer class="py-4" style="background-color: #334E68;">
        <div class="container text-center">
            <div class="row align-items-center">
                <div id="icon" class="col-md-4 text-lg-left">
            ...
            <div class=" col-md-4 text-center">
                ...
                <div class="col-md-4 text-lg-right">
                    <p class="mb-0 text-muted text-small text-heading">Copyright &copy; All Rights Reserved. </p>
                </div>
            </div>
        </div>
    </footer>
